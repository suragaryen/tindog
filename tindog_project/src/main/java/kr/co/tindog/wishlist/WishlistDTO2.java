...
public class WishlistDTO2 {
	...
	public String toString() {
		return "WishlistDTO2 [WISHLIST_NO=" + WISHLIST_NO + ", EMAIL=" + EMAIL + ", UPRODUCT_NO=" + UPRODUCT_NO
				+ ", WISHDATE=" + WISHDATE + ", SUBJECT=" + SUBJECT + ", NICKNAME=" + NICKNAME + ", UPRODUCT_CD="
				+ UPRODUCT_CD + ", PRICE=" + PRICE + ", INFO=" + INFO + ", STATUS=" + STATUS + ", REGDATE=" + REGDATE
